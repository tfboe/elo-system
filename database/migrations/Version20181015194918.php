...
//<editor-fold desc="Public Methods">
  ...
  public function down(Schema $schema)
  {
    ...
    $this->addSql('ALTER TABLE elo_rankingSystemChanges ADD CONSTRAINT FK_60DF3052BF9F2E56 FOREIGN KEY (hierarchy_entity_id) REFERENCES tournament_hierarchy_entities (id)');
  }
